...
public class SignUtil {
    ...
    private final static String SALT = "HTTPADAD";

    /**
     * 签名方法
     * 本方法将Request中的httpMethod、headers、path合成一个字符串用hmacSha256算法双向加密进行签名
     *
     ...
     * @return signResults
     */
    public static String sign(String method, String appSecret, Map<String, String> headerParams, String pathWithParams) {
        try {
            String methodSalt = method + SALT;
            ...
            String signString = combineParamsTogether(methodSalt, headerParams, pathWithParams, null, null);
